...
const Footer = () => {
    ...
    return (
        <div>
            <footer class="footer footer-center mt-5 bg-base-200 text-base-content rounded">
                <div class="grid pt-3 grid-flow-col gap-4">
                ...
                <div>
                    <div class="grid p-0 grid-flow-col gap-4">
