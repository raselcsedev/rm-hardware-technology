...
const Footer = () => {
    ...
    return (
        <div>
            <footer className="footer footer-center mt-5 bg-base-200 text-base-content rounded">
                <div className="grid pt-3 grid-flow-col gap-4">
                    <Link to="" className="link link-hover">About us</Link>
                    <Link to="" className="link link-hover">Contact</Link>
                </div>
                <div>
                    <div className="grid p-0 grid-flow-col gap-4">
                ...
                <div>
                <p className='pb-3'>copyright <small>&copy; {year} all right reserved</small></p>
                </div>
            </footer>
        </div>
    );
